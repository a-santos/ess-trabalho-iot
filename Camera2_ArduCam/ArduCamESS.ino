...
static const size_t bufferSize = 2560; // 4096; //2048; //1024;
...
//const char *ssid = "droid_wlan"; // Put your SSID here
//const char *password = "WlanDr01d16"; // Put your PASSWORD here

const char* ssid     = "droid_wlan";
const char* password = "WlanDr01d16";

//static IPAddress ip(192, 168, 1, 150); // static IP used for browser access: http://IPaddress
